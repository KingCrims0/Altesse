			...
			<div class="row">
				...
				<div class="col-lg-8 order-1 order-lg-2">
					<div class="service-details">
						...
						<img src="assets/images/sapconstruction.jpeg" alt="Images" class="mb-35" />
						<p>
							En nous appuyant sur des années d’expérience dans la maintenance de bâtiments, 
							nous allons travailler pour réaliser un nettoyage intensif pour n’importe quel endroit. 
							Que vous ayez besoin de services de nettoyage de bâtiments ou d’enlèvement 
							régulier des décombres pour un projet en cours, nous sommes là pour vous aider.
						</p>
								...
								<div class="col-md-6">
									<ul>
											<li>
												...
												<p>
													Dans le cadre du processus de nettoyage après rénovation, 
													nous transporterons tous les déchets de construction ou de 
													démolition vers des sites d’élimination désignés conformément 
													à la réglementation gouvernementale. 
													Pour garder les déchets gérables, 
													nous prendrons également les mesures nécessaires 
													pour mettre en quarantaine les débris en un seul 
													endroit pour le transport
												</p>
											</li>
									</ul>
								</div>
								<div class="col-md-6">
									<ul>
										...
										<li>
											...
											<p>
												Nous avons l’équipement et la main d’œuvre pour faire n’importe quel travaux.
											</p>
										</li>
									</ul>
								</div>
