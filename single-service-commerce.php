			...
			<div class="row">
				...
				<div class="col-lg-8 order-1 order-lg-2">
					<div class="service-details">
						...
						<img src="assets/images/scommerce.jpeg" alt="Images" class="mb-35" />
						<p>
							Service de nettoyage pour Entreprises par des profesionnels qualifiés à prix compétitifs.
						</p>
						<h3>On s'occupe de votre commerce!</h3>
						<p>
							Vous avez une entreprise située en France et 
							souhaitez que son nettoyage soit assuré par une équipe fiable et compétente? 
							Ne cherchez plus, vous êtes au bon endroit!
						</p>
						<div class="service-list mb-40">
							<ul>
								<li>
									<i class="fas fa-check"></i>Pour toute demande de soumission ou d’information, composez le 0749219570 ou consultez notre page contact.
								</li>
								<li>
									<i class="fas fa-check"></i>La soumission est toujours gratuite et rapide.
								</li>
								...
								<div class="col-md-6">
									<ul>
											<li>
												...
												<p>
													Entretien ménager commercial complet & en profondeur. 
													Contactez-nous dès aujourd'hui! Bon rapport qualité/prix et équipe polyvalente.
												</p>
											</li>
									</ul>
								</div>
								<div class="col-md-6">
									<ul>
										...
										<li>
											...
											<p>
												Rendez-vous Rapide. Prix Compétitifs. Estimation Gratuite. Service Professionnel. 
											</p>
										</li>
									</ul>
								</div>
