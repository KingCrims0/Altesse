			...
			<div class="row">
				...
				<div class="col-lg-8 order-1 order-lg-2">
					<div class="service-details">
						...
						<img src="assets/images/sconciergerie.jpeg" alt="Images" class="mb-35" />
						<p>
							Nous peaufinons vos aires communes, salles de réception et de séjour, etc. Nos professionnels nettoient en toute discrétion. Vos résidents ne sont pas dérangés.
							Dans tous les secteurs, nous procédons à l’enlèvement des déchets, à l’époussetage de basses et hautes surfaces, au lavage des planchers et nous passons l’aspirateur sur tous les tapis.
						</p>
						<h3>Nous allons vous aider à réaliser vos travails de nettoyage.</h3>
						<p>
						Nous lavons et désinfectons les toilettes en utilisant des produits de grande efficacité qui laissent une bonne odeur de fraîcheur et de propreté.
						</p>
						<div class="service-list mb-40">
							<ul>
								<li>
									<i class="fas fa-check"></i>Satisfaction garantie
								</li>
								<li>
									<i class="fas fa-check"></i>Soumission gratuite et rapide!
								</li>
								...
								<div class="col-md-6">
									<ul>
											<li>
												...
												<h4>Experts en conciergerie</h4>
												<p>
													Maintenir l’élégance et le prestige de votre immeuble est notre spécialité.
												</p>
											</li>
									</ul>
								</div>
								<div class="col-md-6">
									<ul>
										...
										<li>
											...
											<p>
												Voulez-vous obtenir un devis sur nos prix de nettoyage commercial ou résidentiel ? Contactez-nous maintenant! 
											</p>
										</li>
									</ul>
								</div>
