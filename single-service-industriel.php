			...
			<div class="row">
				...
				<div class="col-lg-8 order-1 order-lg-2">
					<div class="service-details">
						...
						<img src="assets/images/sindustriel.jpeg" alt="Images" class="mb-35" />
						<p>
							Confiez le nettoyage de votre site industriel à des professionnels. Contactez-nous maintenant et nous auront le plaisir de vous recontacter dans les plus brefs délais pour une soumission gratuite.
						</p>
						<h3>On s'occupe de vous</h3>
						<p>
							Dans les installations de fabrication, 
							les entrepôts ou autres locaux industriels, 
							un environnement propre influe directement sur la sécurité et la protection. 
							La sécurité joue un rôle particulièrement important dans les activités des centres 
							de distribution et des entrepôts. La protection est également cruciale dans les 
							installations de fabrication et industrielles. 
							C’est pourquoi vous devez faire appel à une équipe de nettoyage 
							industriel qui reconnaît ces deux priorités et qui les respecte.
						</p>
						<div class="service-list mb-40">
							<ul>
								<li>
									<i class="fas fa-check"></i>Soumission gratuite
								</li>
								<li>
									<i class="fas fa-check"></i>Dévoués
								</li>
								<li>
									<i class="fas fa-check"></i>Passionnés
								</li>
								<li>
									<i class="fas fa-check"></i>100% professionnel
								</li>
								<li>
									<i class="fas fa-check"></i>Réponse rapide et tarfis compétitifs
								</li>
								...
								<div class="col-md-6">
									<ul>
											<li>
												...
												<p>
													Laissez entre les mains de nos experts s'occuper de votre projet d'entretien de nettoyage.
												</p>
											</li>
									</ul>
								</div>
								<div class="col-md-6">
									<ul>
										...
										<li>
											...
											<p>
												Altesse définit les méthodes, les outils et l’équipement pour la qualité de nos services.  
											</p>
										</li>
									</ul>
								</div>
