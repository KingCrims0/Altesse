			...
			<div class="row">
				...
				<div class="col-lg-8 order-1 order-lg-2">
					<div class="service-details">
						...
						<p>
							Un service complet de nettoyage et de désinfection pour réduire l’exposition aux risques. Altesse maintient votre environnement de travail propre et sain pour employés et patients.
						</p>
						<h3>On s'occupe de vous.</h3>
						<p>
							Le Service d'Entretien est responsable du nettoyage à l'hôpital. 
							Son travail consiste en un nettoyage régulier, 
							quotidien et de toutes les surfaces de l'hôpital ainsi que du maintien d'un 
							niveau élevé d'hygiène dans l'établissement.
						</p>
						<div class="service-list mb-40">
							<ul>
								...
								<li>
									<i class="fas fa-check"></i>Désinfection complète du milieu
								</li>
								<li>
									<i class="fas fa-check"></i>Votre sécurité avant tout
								</li>
								...
								<div class="col-md-6">
									<ul>
											<li>
												...
												<p>
													Assurance qualité. Sécurité à chaque étape. 
								...
								<div class="col-md-6">
									<ul>
										...
										<li>
											...
											<p>
												Chez Altesse la satisfaction de nos services est primordiale et très importante pour nous.
											</p>
										</li>
									</ul>
								</div>
