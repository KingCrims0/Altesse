			...
			<div class="row">
				...
				<div class="col-lg-8 order-1 order-lg-2">
					<div class="service-details">
						...
						<img src="assets/images/sparking.jpeg" alt="Images" class="mb-35" />
						<p>
                            La propreté c'est aussi avoir un parking propre sans encombrement 
                            car c'est l'image externe de votre entreprise, votre commerce ou votre immeuble. 
                            On y pense jamais et on n'a pas souvent le temps. 

                            Plus de soucis à se faire Altesse met à votre disposition une équipe de confiance 
                            prêts à vous débarrasser de tous déchets ou objets visant à rendre votre parking 
                            défectueux.
						</p>
								...
								<div class="col-md-6">
									<ul>
											<li>
												...
												<p>
                                                    Nous débarrasserons la zone de tous détritus, 
                                                    mégot, résidu ainsi que des odeurs nauséabondes inhérentes à ce type de lieu.
                                                    
                                                    Nous éliminerons également les salissures et les zones glissantes 
                                                    provoquées par les taches d’huile ou de graisse aussi incommodantes que dangereuses.
								...
								<div class="col-md-6">
									<ul>
										...
										<li>
											...
											<p>
                                                Pour toute demande de soumission composez le 07 49 21 95 70 ou écrivez nous au contact@altesse-france.fr . 
                                                La soumission est toujours gratuite et rapide
											</p>
										</li>
									</ul>
								</div>
