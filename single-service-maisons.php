			...
			<div class="row">
				...
				<div class="col-lg-8 order-1 order-lg-2">
					<div class="service-details">
						...
						<img src="assets/images/smaison.jpeg" alt="Images" class="mb-35" />
						<p>
							Pour réaliser un nettoyage résidentiel des maisons, appartements ou condos efficace, il faut avoir recours à une bonne méthode. Il ne suffit pas de préparer le matériel et les produits nécessaires au grand ménage.
						</p>
						<h3>Nous pouvons vous aider à réaliser vos projets de grand ménage.</h3>
						<p>
							Imaginez avoir plus de temps pour se détendre et imaginez revenir à 
							la maison pour que tout soit proprement scintillé. 
							Notre système de service de nettoyage a été développé et perfectionné
							en France depuis plus de 5 ans. 
							Altesse s’efforce de vous fournir le meilleur service d’entretien ménager résidentiel possible.
						</p>
						<div class="service-list mb-40">
							<ul>
								<li>
									<i class="fas fa-check"></i>Clients satisfaits
								</li>
								<li>
									<i class="fas fa-check"></i>Professionnel à 100%
								</li>
								<li>
									<i class="fas fa-check"></i>Dévoué
								</li>
								<li>
									<i class="fas fa-check"></i>Passionné par notre travail
								</li>
								...
								<div class="col-md-6">
									<ul>
										...
										<li>
											...
											<p>
												Notre entreprise de nettoyage 
												de maison expert sont vraiment 
												une aubaine pour les propriétaires, 
												qui ont à peine eu le temps pour ce travail. 
												Si vous regardez autour, vous découvrirez un service de nettoyage 
												résidentiel qui couvre la France entière.
											</p>
										</li>
									</ul>
								</div>
